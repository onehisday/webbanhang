...
<head>
    ...
    <link href="{{asset('public/frontend//font-awesome.min.css')}}" rel="stylesheet">
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 090.863.9007</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> nguyenmanhcuong722001@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
	...
	<script src="{{asset('public/frontend//jquery.scrollUp.min.js')}}"></script>
